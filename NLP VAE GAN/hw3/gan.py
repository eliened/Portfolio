...
class Discriminator(nn.Module):
    def __init__(self, in_size):
        ...
        modules.append(nn.Conv2d(self.in_size[0], 32,7,padding=1))
        ...
        modules.append(nn.Conv2d(256,512, 3,padding=1))
        modules.append(nn.ReLU())
        modules.append(nn.Flatten())

        self.forward_path = nn.Sequential(*modules)

        n_features = self.forward_path(torch.zeros((1, *self.in_size))).shape[1]
